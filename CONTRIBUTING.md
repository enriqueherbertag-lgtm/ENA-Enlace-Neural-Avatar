...
Al contribuir, aceptas que tu trabajo sera licenciado bajo **Apache 2.0** (codigo) y **CC BY-SA 4.0** (documentacion), manteniendo los mismos terminos del proyecto.

Las contribuciones de Ana de Deepseek, como asistencia tecnica, estan incluidas bajo la misma licencia y son propiedad del autor principal del proyecto (Enrique Aguayo).
